...
app.layout = html.Div(
    children=[
         html.Div(
            children=html.Img(src="Logo.png", style={'width': '100px', 'height': 'auto'}),
            style={'position': 'absolute', 'top': '10px', 'left': '10px'}
        ),

        html.H1(children='UNIVERSIDAD DE LA SALLE'),
        html.H2(children='Actividad 4. Proyecto: análisis de la mortalidad de casos de covid-19 en Colombia para el año 2020 y 2021.'),
